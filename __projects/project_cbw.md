...
slides:
  - slide: "{{ site.url }}{{ site.baseurl }}/assets/images/01.CBW-homepage-gallery1.jpg"
  ...
  - slide: "{{ site.url }}{{ site.baseurl }}/assets/images/02.CBW-workshops-gallery2.jpg"
  ...
  - slide: "{{ site.url }}{{ site.baseurl }}/assets/images/03.CBW-application-gallery3.jpg"
  ...
  - slide: "{{ site.url }}{{ site.baseurl }}/assets/images/04.CBW-Events-payment-gallery4.jpg"
  ...
  - slide: "{{ site.url }}{{ site.baseurl }}/assets/images/05.CBW-jobs-gallery5.jpg"
