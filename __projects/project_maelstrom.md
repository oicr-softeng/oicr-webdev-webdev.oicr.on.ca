...
slides:
  - slide: "{{ site.url }}{{ site.baseurl }}/assets/images/01.Maelstrome--homepage-gallery1.jpg"
  ...
  - slide: "{{ site.url }}{{ site.baseurl }}/assets/images/02.Maelstrome-data-portal-gallery2.jpg"
  ...
  - slide: "{{ site.url }}{{ site.baseurl }}/assets/images/03.Maelstrome-network-gallery3.jpg"
  ...
  - slide: "{{ site.url }}{{ site.baseurl }}/assets/images/04.Maelstrome-graphics-gallery4.jpg"
