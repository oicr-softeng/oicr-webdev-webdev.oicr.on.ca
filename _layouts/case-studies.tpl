...
layout: default
---
<link type="text/css" rel="stylesheet" media="all" href="{{ site.url }}{{ site.baseurl }}/assets/css/page/case-studies.css" >
  <!-- Main jumbotron for a primary marketing message or call to action -->
    <div class="row banner">
      <div class="banner-background">
        <img src="{{ site.url }}{{ site.baseurl }}/assets/images/bg-casestudy-{{ page.alias }}.jpg" alt="Banner image 1">

          <div class="banner-main">
              <div class="container">
                <div class="banner-title">
                    <h1>{{ page.title }}</h1>
                    <a class="list-btn" href="{{ site.url }}{{ site.baseurl }}/our-work">BACK TO LIST</a>
                </div>
                  ...
                  <div class="challenge-carousel">
                    ...
                    <div class="carousel-inner" role="listbox">
                        ...
                        {% for item in page.challenge.slides limit:challenge-slides %}
                          ...
                          {% endif %}
                                  <div class="slides">
                                      <img class="carousel-img carousel-img-browser" src="{{ site.url }}{{ site.baseurl }}/assets/images/background-browser.svg">
                ...
                <div class="row testimonial">
                  <div class="container">
                    <div class="testimonial-image col-md-2">
                      <img src="{{ site.url }}{{ site.baseurl }}/assets/images/logo-testimonials.svg">
                    </div>
