...
<link type="text/css" rel="stylesheet" media="all" href="{{ site.url }}{{ site.baseurl }}/assets/css/page/homepage.css" >
                    ...
                    <div class="jumbotron-main container">
                        ...
                        <h1>{{ page.title }}</h1>
                            <div class="caption-thumb-content">
                                ...
                                <a class="btn" href="{{ site.url }}{{ site.baseurl }}/our-work/">{{ page.btn_banner }}</a>
                            </div>
                        </div>
                ...
                <div class="row what-we-do">
                    <div class="container">
                        ...
                        <ul>
                            ...
                            <li>
                                <a class="teaser teaser-block" href="{{ site.url }}{{ site.baseurl }}/our-capabilities/#design">
                                    <div class="teaser-image">
                            ...
                            <li>
                                <a class="teaser teaser-block" href="{{ site.url }}{{ site.baseurl }}/our-capabilities/#development">
                                    <div class="teaser-image">
                        ...
                        <div class="about-us-main col-md-10">
                            ...
                            <div class="about-us-content">
                                <div class="about-us-main-content">
                                    ...
                                    <a class="btn" href="{{ site.url }}{{ site.baseurl }}/about-us/">{{ page.about.btn }}</a>
                                </div>
                                <div class="about-us-join">
                                    ...
                                    <a class="btn" href="{{ site.url }}{{ site.baseurl }}/careers/">{{ page.join_the_team.btn }}</a>
                                </div>
                            </div>
                        </div>
                    </div>
