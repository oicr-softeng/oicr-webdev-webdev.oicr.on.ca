...
layout: default
---
<link type="text/css" rel="stylesheet" media="all" href="{{ site.url }}{{ site.baseurl }}/assets/css/page/careers.css" >
                            ...
                            <div class="row careers-main">
                                <div class="container">
                                    <div class="job-postings-img">
                                        <img src="{{ site.url }}{{ site.baseurl }}/assets/images/illustration-careers.svg">
                                    </div>
