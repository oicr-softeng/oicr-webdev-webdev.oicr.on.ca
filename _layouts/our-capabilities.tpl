...
<link type="text/css" rel="stylesheet" media="all" href="{{ site.url }}{{ site.baseurl }}/assets/css/page/our-capabilities.css" >
                      ...
                      <div class="main-content">
                          <div class="row our-capabilities">
                              ...
                              <div class="row health-science-research-domain">
                                  <div class="container">
                                      ...
                                      <div class="section-img">
                                          <img src="{{ site.url }}{{ site.baseurl }}/assets/images/illustration-health-sciences.svg">
                                      </div>
                              ...
                              <div class="row planning-strategy">
                                  <div class="container">
                                      <div class="section-img">
                                          <img src="{{ site.url }}{{ site.baseurl }}/assets/images/illustration-planning.svg">
                                      </div>
                              ...
                              <div class="row design-ux">
                                  <div class="container">
                                      <div class="section-img">
                                          <img src="{{ site.url }}{{ site.baseurl }}/assets/images/illustration-design-and-ux.svg">
                                      </div>
                              ...
                              <div class="row development">
                                  <div class="container">
                                      <div class="section-img">
                                          <img src="{{ site.url }}{{ site.baseurl }}/assets/images/illustration-development.svg">
                                      </div>
