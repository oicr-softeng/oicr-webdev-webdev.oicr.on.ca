...
body:
    ...
    html: >
        ...
        <br />Please click the following to download a copy of the Website User Consent Statement:<br /><br /><a class="mobile-button" href="[consentUrl]" style="-webkit-text-size-adjust: none; background-color: [buttonColor]; border: 1px solid [buttonColor]; border-radius: 3px; border-width: 1px; color: #fff; display: inline-block; font-family: [fontFamily]; font-size: 16px; font-weight: bold; line-height: 42px; padding: 0 30px 0 30px; text-align: center;" target="_blank">Download Consent Statement</a></td>
        </tr>
