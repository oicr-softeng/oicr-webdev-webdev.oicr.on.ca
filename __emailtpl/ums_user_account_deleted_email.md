...
body:
    ...
    html: >
        ...
        <tr>
        <td align="center" style="border-bottom: 2px solid #535353; border-top: 2px solid #535353; color: [primaryColor]; font-family: [fontFamily]; font-size: 22px; line-height: 28px; mso-table-lspace: 0pt; mso-table-rspace: 0pt; padding: 12px 0 12px 0;">Account Deleted</td>
        </tr>
        </table>
        </td>
        </tr>
        ...
        <br />Your account (<strong>[email_to]</strong>) on <a class="apple-links" href="https://[base_url]" style="color: [primaryColor]; font-weight: bold; text-decoration: underline;" target="_blank">[base_url]</a> has been deleted.<br />
        <br /> If believe this was a mistake, please <a href="mailto:[signatureEmail]" style="color: [primaryColor]; font-weight: bold; text-decoration: underline;">contact us</a>.<br />
        <br /> Thank you,<br />
