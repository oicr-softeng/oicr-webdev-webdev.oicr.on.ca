...
body:
    ...
    html: >
        ...
        <p style="margin-bottom: 18px; font-size: 14px; line-height: 21px;">Your account (<strong>[email_to]</strong>) on <a class="apple-links" href="[base_url]" style="color: [primaryColor]; font-weight: bold; text-decoration: underline;" target="_blank">[base_url]</a> has been deleted.</p>
        <p style="margin-bottom: 24px; font-size: 14px; line-height: 21px;">If believe this was a mistake, please <a href="mailto:[signatureEmail]" style="color: [primaryColor]; font-weight: bold; text-decoration: underline;">contact us</a>.</p>
