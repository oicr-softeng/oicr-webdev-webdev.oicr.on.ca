...
body:
    ...
    html: >
        ...
        <body bgcolor="#ffffff" style="height: 100% !important; margin: 0; padding: 0;">
        <!-- CONTAINER: Header -->
        ...
        <p style="margin-bottom: 24px; font-size: 14px; line-height: 21px;">We need you to confirm that you changed your email address for your <a class="apple-links" href="[base_url]/" style="color: [primaryColor]; font-weight: bold; text-decoration: underline;" target="_blank">[base_url]</a> account. Please click the link below to verify this is your new email address.</p>
        ...
        <p style="margin-bottom: 24px; font-size: 14px; line-height: 21px;">We appreciate your understanding and co-operation.</p>
