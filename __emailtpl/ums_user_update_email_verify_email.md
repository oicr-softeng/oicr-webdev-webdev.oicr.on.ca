...
body:
    ...
    html: >
        ...
        <br /> We need you to confirm that you changed your email address for your <a class="apple-links" href="[base_url]/" style="color: [primaryColor]; font-weight: bold; text-decoration: underline;" target="_blank">[base_url]</a> account. Please click the link below to verify this is your new email address. <!-- VML-BASED BUTTON -->
        <table border="0" cellpadding="0" cellspacing="0" style="border-collapse: collapse !important; mso-table-lspace: 0pt; mso-table-rspace: 0pt;" width="100%">
        <tr>
