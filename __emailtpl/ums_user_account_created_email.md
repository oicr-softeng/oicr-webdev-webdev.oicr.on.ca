...
body:
    ...
    html: >
        ...
        <img alt="[siteName]" border="0" class="fluid-image" height="98"
        src="[logoUrl]" style="background-color: #fff; border: 0; color: [primaryColor]; display: block; font-family: [fontFamily]; font-size: 11px; font-weight: normal;   height: auto; line-height: 21px; outline: none; padding: 0; text-decoration: none;"
        width="135" />
        </td>
        </tr>
        <tr>
        <td align="center" style="border-bottom: 2px solid #535353; border-top: 2px solid #535353; color: [primaryColor]; font-family: [fontFamily]; font-size: 22px; line-height: 28px; mso-table-lspace: 0pt; mso-table-rspace: 0pt; padding: 12px 0 12px 0;">Account Successfully Created</td>
        </tr>
        </table>
        </td>
        </tr>
        ...
        width="100%">
        <tr>
        <td align="center" style="color: #000000; font-family: [fontFamily]; font-size: 13px; font-weight: normal; line-height: 21px; mso-table-lspace: 0pt; mso-table-rspace: 0pt;">This email was sent to
        ...
        <br
        /> © [poweredByName]. All Rights Reserved.
        <br />
        <br />
        </td>
        </tr>
